...
console.log("exponent3333  = = "+ exponent3333)
		//step 1
		...
		function rightSideOfOperation(){
			...
			//reduce coefficient using LCM -- no mixed fractions used here 
	 		var numerator1 = leftOfEqualNumerator1/gcd_rec(leftOfEqualNumerator1, leftOfEqualDenominator);
			var denominator1 = leftOfEqualDenominator /gcd_rec(leftOfEqualNumerator1, leftOfEqualDenominator);
			...
			console.log("exponent44444444 " + exponent4)
					...
					//+ '+' + backSlash+'frac{'+ numerator1 + 'x' + '^{' +  Math.abs(exponent4)  +  '}' + '}{'+ denominator1 +   '}'  +  backSlash + backSlash;//concat to leftside of operation
							...
							if ((numerator1==1)&&(denominator1==1)){
								...
								'x' + '^{' +  Math.abs(exponent4)  +  '}' +  backSlash + backSlash;	//concat to leftside of operation

							}else if ((numerator1==1)&&(denominator1!=1)){
								//console.log("((numerator==1)&&(denominator!=1))")
								//concatFeedbackItems = concatFeedbackItems +  '&=' +backSlash+'frac{'+ 'x' + '^{' +  Math.abs(exponent4)  +  '}' + '}{'+ denominator1 +   '}'  +  backSlash + backSlash;
						console.log("EEEEEEE")
						concatFeedbackItems = concatFeedbackItems + '+' +backSlash+'frac{'+ 'x' + '^{' +  Math.abs(exponent4)  +  '}' + '}{'+ denominator1 +   '}'  +  backSlash + backSlash; //concat to leftside of operation
