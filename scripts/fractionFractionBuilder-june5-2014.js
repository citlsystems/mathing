...
var success;		
  ...
  function fractionFractionBuilder(item_id){
	...
	//var backSlash = String.fromCharCode('92');
		...
		if(item_id == "fractionFractionDenominatorid"){//numerator true
		 ...
		 if(fractionFractionNumeratorActive==true){
			 ...
			 //if(exponentToFractionToggle == true){
					...
					//getFractionFractionItem =   backSlash +'frac{'+numerator+'}{'+denominator+'}';
				 	//base="";
			//}
		...
		/////////////////////////////////update fraction and main panel from this panel/////////////////////////////////////////////////////
		...
		if(numeratorActive==true){//Add items to numerator1
